...
/**
 * Class ShipboardConnection
 *
 * @package Drupal\shipboard
 */
class ShipboardConnection {

    /**
     * @var string Shipboard API version to use
     */
    ...
    /**
     * @var \Drupal\Core\Config\Config Shipboard settings
     */
    ...
    /**
     * ShipboardConnection constructor.
     */
    public function __construct() {
        $this->config = \Drupal::config('shipboard.settings');
    }

    /**
     * Get configuration or state setting for this Shipboard integration module.
     *
    ...
    protected function getConfig($name) {
        ...
        return $this->config->get('shipboard.' . $name);
    }

    /**
     * Pings the Shipboard API for data.
     *
    ...
    public function queryEndpoint($endpoint, $options = []) {
        try {
            ...
            watchdog_exception('shipboard', $e);
            return (object) [
                'response_type' => '',
                'response_data' => [],
                'pagination'    => (object) [
    ...
    /**
     * Call the Shipboard API endpoint.
     *
    ...
    public function callEndpoint($endpoint, $options = []) {
       // $headers = $this->generateHeaders($this->requestUri($endpoint));
        $url     = "https://api.shiftdata.com/servola/api/api.cgi?&access_key_id=15af4df9-da35-4894-b259-606166e33e90&jsonrpc=2.0&id=1&method=account.list&params=e30K&signature=OLVhDWCiPxprE9i54m4rzGwTSuU%3D";
    ...
    /**
     * Build a Url object of the URL data to query the Shipboard API.
     *
     * @param string $endpoint to the API data
    ...
    /**
     * Build an array of headers to pass to the Shipboard API such as the
    ...
    /**
     * Builds a hash for the x-signature to send to the Shipboard API according to
     * specifications.
     *
    ...
    /**
     * Builds a hash for the x-account to send to the Shipboard API according to
     * specifications.
