...
namespace Drupal\http_client_manager_shiftboard\Plugin\HttpServiceApiWrapper;

use Drupal\http_client_manager\Plugin\HttpServiceApiWrapper\HttpServiceApiWrapperBase;
use Drupal\http_client_manager_shiftboard\api\Commands\Posts;
...
class HttpServiceApiWrapperPosts extends HttpServiceApiWrapperBase {
  ...
  public function getHttpClient() {
    return $this->httpClientFactory->get('shiftboard_services_yaml');
  }
