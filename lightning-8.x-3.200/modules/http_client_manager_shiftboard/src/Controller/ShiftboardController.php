...
namespace Drupal\http_client_manager_shiftboard\Controller;
 ...
 *
 * @package Drupal\http_client_manager_shiftboard\Controller
 */
class shiftboardController extends ControllerBase {
   ...
   *
   * @var \Drupal\http_client_manager_shiftboard\Plugin\HttpServiceApiWrapper\HttpServiceApiWrapperPosts
   */
  protected $api;
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('shiftboard_api.http_client'),
      $container->get('http_client_manager_shiftboard.api_wrapper.posts'),
  ...
  protected function buildPostResponse(array $post, $post_link, $advanced = FALSE) {
    $route = $advanced ? 'http_client_manager_shiftboard.find_posts.advanced' : 'http_client_manager_shiftboard.find_posts';
  ...
  public function createPostAdvanced() {
    ...
    // Here we are using an HTTP Config Request just for shiftboard purposes.
